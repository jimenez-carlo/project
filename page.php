      ...
      if (count($commodities) > 0) {
        foreach ($commodities as $commodity) {
            ...
            $select[] = "
              ...
              WHERE p.deleted_flag = 0 AND p.comodity_id = {$commodity_id} GROUP BY p.comodity_id
            ";
        }
