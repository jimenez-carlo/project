    ...
    <div class="row">
      <div class="col-12">
        ...
        <form method="post" name="project_edit" refresh="admin/project/edit&id=<?= $default->id ?>" enctype="multipart/form-data">
          <button type="submit" class="btn btn-dark pull-right" name="create" confirmation="Create New Project?" style="right: 20px;z-index: 99;position: fixed;bottom: 20px;">Create Project</button>
              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" id="residuals_display" value="0">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <div class="input-group datepicker" id="preproc_conducted_date" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#preproc_conducted_date" name="preproc_conducted_date" />
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    <label>*Target Date:</label>
                    <div class="input-group datepicker" id="prebid_target_date" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#prebid_target_date" name="prebid_target_date" />
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label>*Conducted Date:</label>
                    <div class="input-group datepicker" id="prebid_conducted_date" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#prebid_conducted_date" name="prebid_conducted_date" />
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-4">
                  <div class="form-group">
                    <label>*Target Date:</label>
                    <div class="input-group datepicker" id="sobe_target_date" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#sobe_target_date" name="sobe_target_date" />
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <label>*Conducted Date:</label>
                    <div class="input-group datepicker" id="sobe_conducted_date" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#sobe_conducted_date" name="sobe_conducted_date" />
                ...
                <div class="col-sm-4">
                  ...
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="no_bidder" name="no_bidder">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    <label>*Target Date:</label>
                    <div class="input-group datepicker" id="pq_target_date" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#pq_target_date" name="pq_target_date" />
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label>*Conducted Date:</label>
                    <div class="input-group datepicker" id="pq_conducted_date" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#pq_conducted_date" name="pq_conducted_date" />
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    <label>*Conducted Date:</label>
                    <div class="input-group datepicker" id="pqr_conducted_date" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#pqr_conducted_date" name="pqr_conducted_date" />
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    <label>*Conducted Date:</label>
                    <div class="input-group datepicker" id="noa_conducted_date" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#noa_conducted_date" name="noa_conducted_date" />
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    <label>*Conducted Date:</label>
                    <div class="input-group datepicker" id="ors_conducted_date" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#ors_conducted_date" name="ors_conducted_date" />
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    <label>*Conducted Date:</label>
                    <div class="input-group datepicker" id="ntp_conducted_date" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#ntp_conducted_date" name="ntp_conducted_date" />
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-4">
                  <div class="form-group">
                    <label>*Conducted Date:</label>
                    <div class="input-group datepicker" id="ntp_conforme_conducted_date" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#ntp_conforme_conducted_date" name="ntp_conforme_conducted_date" />
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control form-control-sm" name="ntp_delivery_period" id="ntp_delivery_period">
                  </div>
                </div>
                <div class="col-sm-4">
                  <div class="form-group">
                    <label>*LDD:</label>
                    <div class="input-group datepicker" id="ldd_date" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#ldd_date" name="ldd_date" />
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control float-right daterange" id="delivery_conducted_date" name="delivery_conducted_date">
                    </div>
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control float-right daterange" id="inspected_conducted_date" name="inspected_conducted_date">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card-body">
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control float-right daterange" id="accepted_conducted_date" name="accepted_conducted_date">
                    </div>
                  </div>
                </div>
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <div class="form-group" style="display:flex">
                      <div class="form-check" style="width:15%">
                        <input class="form-check-input" type="radio" name="dv" value="1">
                        <label class="form-check-label">Yes</label>
                      </div>
                      <div class="form-check" style="width:15%">
                        <input class="form-check-input" type="radio" name="dv" value="0">
                        <label class="form-check-label">No</label>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="form-group">
                    <label>Date:</label>
                    <div class="input-group datepicker" id="accepted_date_1" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#accepted_date_1" name="accepted_date_1" />
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control form-control-sm" name="retention_amount" id="retention_amount">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-4">
                  <div class="form-group">
                    <label>Date:</label>
                    <div class="input-group datepicker" id="accepted_date_2" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#accepted_date_2" name="accepted_date_2" />
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control form-control-sm" name="ld_amount" id="ld_amount">
                  </div>
                </div>
                <div class="col-sm-4">
                  <div class="form-group">
