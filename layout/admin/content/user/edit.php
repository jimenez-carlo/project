    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="card">
          ...
          <!-- /.card-header -->
          <form method="post" name="user_update" refresh="admin/user/create">
            <div class="card-body">
              <div class="row">
                <div class="col-sm-3">
            ...
            <div class="card-footer">
              <button type="submit" class="btn btn-sm btn-dark float-right" name="edit" confirmation="Save New Changes?">Create Account</button>
            </div>
          </form>
          <!-- /.card-body -->
        </div>
